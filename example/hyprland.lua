...
hl.bind(mainMod .. " + V", hl.window.toggle_float())
...
hl.bind(mainMod .. " + left",  hl.focus.direction("l"))
hl.bind(mainMod .. " + right", hl.focus.direction("r"))
hl.bind(mainMod .. " + up",    hl.focus.direction("u"))
...
hl.bind(mainMod .. " + SHIFT + S", hl.workspace.move_window("special:magic"))

-- Scroll through existing workspaces with mainMod + scroll
hl.bind(mainMod .. " + mouse_down", hl.workspace.go("e+1"))
hl.bind(mainMod .. " + mouse_up",   hl.workspace.go("e-1"))
